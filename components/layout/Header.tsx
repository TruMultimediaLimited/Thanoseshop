...
const BOX_BTN =
  "border-border bg-card hover:border-primary hover:text-primary inline-flex size-10 shrink-0 items-center justify-center rounded-lg border transition-colors";

const DEFAULT_WHATSAPP = "+8801833534123";
